...
export const productsRows = [{id:1,name:"Ipad Air 8",img:"https://robohash.org/velnihilnobis.png?size=50x50&set=set1",stock:89,status:"active",price:"496.28"},
{id:2,name:"Apple Watch 7",img:"https://robohash.org/nobisrepudiandaereiciendis.png?size=50x50&set=set1",stock:99,status:"active",price:"459.01"},
{id:3,name:"Macbook Air M1 2020",img:"https://robohash.org/verovoluptasmolestiae.png?size=50x50&set=set1",stock:99,status:"active",price:"177.85"},
{id:4,name:"Macbook Pro M1 2020",img:"https://robohash.org/sitdoloremqueenim.png?size=50x50&set=set1",stock:29,status:"active",price:"219.72"},
{id:5,name:"Macbook Pro 2022",img:"https://robohash.org/veniametut.png?size=50x50&set=set1",stock:24,status:"active",price:"60.22"},
{id:6,name:"Ipad Mini 2021",img:"https://robohash.org/sapientequiadolorem.png?size=50x50&set=set1",stock:46,status:"active",price:"3.29"},
{id:7,name:"Aplle TV",img:"https://robohash.org/ideligendinesciunt.png?size=50x50&set=set1",stock:11,status:"active",price:"399.92"},
